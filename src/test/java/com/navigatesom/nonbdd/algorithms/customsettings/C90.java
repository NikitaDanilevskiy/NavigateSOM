...
public class C90 extends BaseTest {

    @Test(description = "C90, Algorithm2 - Valid Include Custom settings with Averaging Period " +
    ...
    public void checkingThe1bAlgorithm()
    {
        ...
        Pages.newSomAdminTenantsPage().expandAlgorithm(1);
        Pages.newSomAdminTenantsPage().clickAddSettingsButtonA2();
        Pages.newSomAdminTenantsPage().switchSliderA1b();
        Pages.newSomAdminTenantsPage().typeCustomerIdA2("FF0000244");
        //Pages.newSomAdminTenantsPage().typeTradeA1("Trade");
        Pages.newSomAdminTenantsPage().typeThresholdA2("1");
        Pages.newSomAdminTenantsPage().selectAveragingPeriodA2("From Last Day of Previous Month");
        Pages.newSomAdminTenantsPage().selectNumberOfMonthA2("12 Month (s)");
        ...
        Assert.assertTrue(reasons.contains("Algorithm 2: Order over cost average"));
    ...
    public void deleteLastUploadAndCustomSetting()
    {
        ...
        Pages.newSomAdminTenantsPage().clickRemoveCustomSettingA2Button();
        SelenideTools.sleep(2);
