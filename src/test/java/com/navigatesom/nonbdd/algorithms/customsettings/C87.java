...
public class C87 extends BaseTest {

    @Test(description = "C87, Algorithm5b - Valid Include Custom settings with Averaging Period " +
    ...
    public void checkingThe1bAlgorithm()
    {
        ...
        Pages.newSomAdminTenantsPage().expandAlgorithm(10);
        Pages.newSomAdminTenantsPage().clickAddSettingsButtonA5b();
        Pages.newSomAdminTenantsPage().switchSliderA1b();
        Pages.newSomAdminTenantsPage().typeCustomerIdA5b("FF0000244");
        Pages.newSomAdminTenantsPage().typeNdcA5b("10702002501");
        Pages.newSomAdminTenantsPage().typeThresholdA5b("1");
        Pages.newSomAdminTenantsPage().selectAveragingPeriodA5b("From Last Day of Previous Month");
        Pages.newSomAdminTenantsPage().selectNumberOfMonthA5b("12 Month (s)");
    ...
    public void deleteLastUploadAndCustomSetting()
    {
        ...
        Pages.newSomAdminTenantsPage().clickRemoveCustomSettingA5bButton();
        SelenideTools.sleep(2);
